...
public class ServiceAdapter extends RecyclerView.Adapter<ServiceAdapter.DailyViewHolder> {
    ...
    public ServiceAdapter(Context context, ArrayList<ServiceModel> data, OnClickChoose listener) {
        mContext = context;
        mCateList = data;
    ...
    public DailyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.row_service, viewGroup, false);
